...
const translations = {
    ...
    et: {
        ...
        next: 'Järgmine',
        'no-bike-allowed-popup':
            'Bussides ja trammides ei ole jalgrattad lubatud. Kui sa kasutad neid liinil, jäta jalgratas peatusesse või pargi & sõida juures.',
        'no-departures': 'Väljumisi pole',
        'no-favourite-locations':
            'Lisa siin enim kasutatavad kohad. Nupud planeerivad marsruudi koheselt.',
        'no-favourites':
            'Kasuta tähti, et lisada liine või peatusi lemmikutesse . Lemmikud kuvatakse sellel lehel.',
        ...
        routes: 'Liinid',
        'routes-platforms': 'Liinid, platvormid',
        run: 'Käivita',
        save: 'Salvesta',
        search: 'Otsi',
        ...
        'transfers-margin': 'Ümberistumiste osakaal  vähemalt',
        ...
        walk: 'kõndimine',
        'walk-distance-duration': 'Kõndimine {distance} ({duration})',
