...
const translations = {
    ...
    et: {
        ...
        'geolocation-failed-text':
            'Sinu lehitseja ei toeta asukoha otsingut.',
        'geolocation-prompt-text':
        ...
        'route-page.description': 'Teekond {route_short_name} - {route_long_name}',
        'route-page.title': 'Teekond {route_short_name}',
        ...
        'use-national-service':
            'Võid proovida riiklikku teenust ',
    ...
    ru: {
        ...
        'give-name-to-location': 'Укажите описательное название Вашего местоположения',
        'give-origin': 'Введите место отправления.',
        'give-position': 'Введите местоположение или место отправления в строке поиска.',
        'give-route': 'Поиск маршрута',
        hour: 'Час',
        'hour-short': 'ч.',
        'how-to-rate-service': 'Как Вы оцениваете услугу?',
        'in-addition': 'Дополнительно',
        inquiry: 'Как Вы нашли новый «Планировщик Поездки»? Пожалуйста, сообщите нам!',
